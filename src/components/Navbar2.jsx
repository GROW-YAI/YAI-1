  ...
  return (
    <nav className="bg-white pt-2 px-4 sm:px-8 md:px-16 lg:px-24 sticky top-0">
      <div className="container py-2 flex justify-between items-center">
        ...
        {/* Navigation Links */}
        <div className={`absolute lg:static top-14 left-0 w-full lg:w-auto bg-white lg:bg-transparent transition-all duration-300 ease-in-out ${menuOpen ? 'block' : 'hidden'} lg:flex`}>
          <ul className="flex flex-col lg:flex-row gap-4 lg:gap-14 text-center p-4 lg:p-0">
            <li className="hover:text-[#FE5C24] transition-all duration-500">
              <a href="/">Home</a>
            </li>
            <li className="hover:text-[#FE5C24] transition-all duration-500">
              <HashLink scroll={scrollWithSmoothEffect} to="/#about">About</HashLink>
            </li>
            <li className="hover:text-[#FE5C24] transition-all duration-500">
              <HashLink scroll={scrollWithSmoothEffect} to="/#innovator">Innovator</HashLink>
            </li>
            <li className="hover:text-[#FE5C24] transition-all duration-500">
              <HashLink scroll={scrollWithSmoothEffect} to='/#products'>Products</HashLink>
            </li>
            <li className="hover:text-[#FE5C24] transition-all duration-500">
              <HashLink scroll={scrollWithSmoothEffect} to='/#testimonials'>Testimonials</HashLink>
            </li>
            <li className="hover:text-[#FE5C24] transition-all duration-500">
              <HashLink scroll={scrollWithSmoothEffect} to='/#contact'>Contact</HashLink>
            </li>
          </ul>
        </div>
